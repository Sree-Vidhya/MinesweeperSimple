...
public class GameLogic {
    ...
    public GameLogic(GameInput gameInput, String layout) {
        this.gameInput = gameInput;
        rows = gameInput.generateRows(layout);
        columns = gameInput.generateColumns(layout);
        totalCells = gameInput.generateTotalCells(rows,columns);
        fieldCreated = gameInput.getMatrix();
    }
